    ...
    public partial class kitapListeleFrm : Form
    {
        ...
        private void btn_kitapGuncelle_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection baglanti = new SqlConnection(connectionString))
            {
                ...
                SqlCommand komut = new SqlCommand("SELECT eser FROM kitaplar WHERE demirbas = @demirbas", baglanti);
                ...
                if (read.Read())
                {
                    ...
                    // Güncelleme işlemi
                    SqlCommand updateCommand = new SqlCommand("UPDATE kitaplar SET eser = @eser, yazar = @yazar, yayinlayan = @yayinlayan, " +
            ...
            using (SqlConnection baglanti = new SqlConnection(connectionString))
            {
                ...
                if (read.Read())
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        if (password == "1234")
                        {
                            SqlCommand deleteCommand = new SqlCommand("DELETE FROM kitaplar WHERE demirbas = @demirbas", baglanti);
        ...
        {
            DataView dv = daset.Tables["kitaplar"].DefaultView;
